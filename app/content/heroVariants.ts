import type { HeroContent } from "../components/sections/hero/Hero";

export const heroVariants: HeroContent[] = [
  {
    eyebrow: "Aby finance dávaly smysl",
    title: {
    ...
    cta: {
      primary: { label: "Nezávazná konzultace", href: "#lead-form" },
  ...
  {
    eyebrow: "Bez stresu, bez složitých slov",
    title: {
      line1: "Nejdřív Přehled",
      line2: "Potom Jasný Plán",
      highlight: "Přehled",
  ...
  {
    eyebrow: "Jasně, srozumitelně, lidsky",
    title: {
      line1: "Nejdřív Přehled",
      line2: "Potom Jasný Plán",
      highlight: "Přehled",
